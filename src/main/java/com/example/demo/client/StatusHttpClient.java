...
public class StatusHttpClient extends Thread {
    ...
    public StatusHttpClient(Student student, int index) {
        ...
        try {
            ...
            b.handler(new ChannelInitializer<SocketChannel>() {
                ...
                public void initChannel(SocketChannel ch) throws Exception {
                    ...
                    ch.pipeline().addLast(new ClientStatusHandler(student, host, itemIndex));
